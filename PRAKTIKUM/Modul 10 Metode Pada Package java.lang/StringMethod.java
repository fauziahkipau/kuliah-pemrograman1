public class StringMethod {
  ...
  public static void main(String args[]) {
    ...
    String st = new String(
      "ini untuk mencoba Metode string!"
    );/* menghitung jumlah karakter dari st */
    int pj = st.length();
    System.out.println(
      "1. Hitung jumlah karakter menggunakan perintah .length dari variable pj, dengan hasil hasilnya " +
      pj +
      " karakter"
    );
    ...
    char c = st.charAt(5);
    System.out.println(
      "2. menampilkan karakter ke 5 yang ada i variable c, hasilnya: " + c
    );
    /* apakah st dimulai dengan "ini" */
    boolean b1 = st.startsWith("ini");
    System.out.println(
      "3. Cek apakah kalimat dimulai dari kata ini, hasilnya: " + b1
    );
    /* apakah st dimulai dengan "st" mulai karakter ke-4 */
    boolean b2 = st.startsWith("st", 4);
    System.out.println(
      "4. Cek apakah karakter ke-4 dimulai dengan kata st, hasilnya: " +
      b2 +
      " karna harusnya u"
    );
    ...
    System.out.println(
      "5. cek apakah st diakhiri dengan string. ? hasilnya: " +
      b3 +
      " karna harusnya string!"
    );
    ...
    indeks = st.indexOf('n');
    System.out.println(
      "6. menemukan posisi index pada huruf n menggunakan indexOf, berada di urutan ke " +
      indeks
    );
    while (indeks >= 0) {
    ...
    System.out.println(
      "8. menemukan posisi index pada kata in menggunakan indexOf, berada di urutan ke  " +
      indeks
    );
    while (indeks >= 0) {
      System.out.println("> " + indeks);
    ...
    System.out.println(
      "10. menemukan posisi index yang paling belakang pada huruf n menggunakan lastIndexOf, berada di urutan ke  " +
      indeks
    );
    while (indeks >= 0) {
      System.out.println("> " + indeks);
    ...
    System.out.println(
      "12. menemukan posisi index yang paling belakang pada kata in menggunakan lastIndexOf , berada di urutan ke  " +
      indeks
    );
    while (indeks >= 0) {
      System.out.println("> " + indeks);
    ...
    System.out.println(
      "12. menampilkan substring dari variabel sj dimula dari karakter urutan ke ke-6 sampai akhir. hasilnya: " +
      sub_string
    );
    ...
    System.out.println(
      "st.compareTo(st2.toLowerCase()) : " + st.compareTo(st2.toLowerCase())
    );
    System.out.println(
      "st.compareTo(st2.toUpperCase()) : " + st.compareTo(st2.toUpperCase())
    );
  }
}
